    ...
    <div className="max-w-xl mx-auto bg-white rounded-2xl shadow-lg p-8 mt-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          key !== 'id' && key !== 'userId' && key !== 'createdAt' && key !== 'user' && (
            <div key={key}>
              ...
              <input
                ...
                className="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              />
            </div>
          )
        ))}
        <div className="flex justify-end space-x-2">
          ...
          <button
            type="submit"
            className="px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-600 to-indigo-700 text-white hover:from-indigo-700 hover:to-indigo-800 shadow-md transition-all duration-200"
            disabled={saving}
          >
