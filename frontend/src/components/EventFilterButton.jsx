...
const EventFilterButton = ({ 
  ...
  return (
    <div className="relative z-50" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 sm:w-72 bg-gradient-to-br from-black/80 via-gray-900/90 to-black/80 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/30 z-[99999] max-h-[80vh] overflow-y-auto scrollbar-hide">
