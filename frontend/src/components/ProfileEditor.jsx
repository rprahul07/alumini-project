      ...
      <div className="relative z-10 w-full max-w-4xl bg-white/80 backdrop-blur-xl p-4 sm:p-8 rounded-xl shadow-2xl border border-slate-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      {/* Current CV Display */}
                      {resumeUrl ? (
                        <div className="mb-3 p-3 bg-green-500/20 border border-green-500/30 rounded-xl backdrop-blur-sm">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-sm font-medium text-green-300">Current CV</p>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      {/* Skills Tags */}
                      <div className="min-h-[50px] p-3 bg-white/10 rounded-xl border border-white/20 backdrop-blur-sm">
                        {skills.length > 0 ? (
                          <div className="flex flex-wrap gap-2">
                            {skills.map(skill => (
                              <span
                                key={skill}
                                className="inline-flex items-center gap-1 bg-primary-500/20 text-primary-300 px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-primary-500/30 border border-primary-500/30"
                              >
                                {skill}
                                <button
                                  type="button"
                                  onClick={() => handleSkillRemove(skill)}
                                  className="ml-1 w-4 h-4 rounded-full hover:bg-primary-500/40 flex items-center justify-center transition-colors"
                                >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row justify-end gap-3 pt-6 border-t border-white/20 mt-6"
          >
            <button
              type="button"
              onClick={() => {
