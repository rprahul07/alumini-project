        ...
        <div className="flex justify-between items-center h-14">
              ...
              .map((link) => {
                ...
                return (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `relative px-4 py-2 rounded-full text-sm font-semibold font-sans transition-all duration-300 transform hover:scale-105 overflow-hidden ${
          ...
          <div className="flex items-center space-x-3">
            {user ? (
              <div className="relative dropdown-container" ref={avatarRef}>
                <button
                  ...
                  className={`flex items-center space-x-2 p-1.5 rounded-full backdrop-blur-xl border transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl ${
                    isDarkBackgroundPage
            ...
            <button
              ...
              className={`lg:hidden p-1.5 rounded-full backdrop-blur-xl border transition-all duration-300 shadow-xl ${
                isDarkBackgroundPage
                  ? 'bg-slate-100 border-slate-200 hover:bg-slate-200'
                  : 'bg-slate-50 border-slate-200 hover:bg-slate-100'
              }`}
